...
import { getProfileImagePath } from "../utils/assetPaths";

const Profile = ({ onNavigate }) => {
  // Illustration SVG assets
  const img = getProfileImagePath("complexity-shape-1.svg");
  const img1 = getProfileImagePath("complexity-shape-2.svg");
  const img2 = getProfileImagePath("complexity-shape-3.svg");
  const imgFrame4 = getProfileImagePath("into-this-line.svg");
  const imgVector4 = getProfileImagePath("arrow.svg");
